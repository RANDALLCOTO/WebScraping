...
//LISTS
export const CURRENCY_LIST = [{value:"CRC", label:"Colones"},{value:"USD", label:"Dólares"}];
export const CATEGORY_TYPES = [{value:"PRIMARY", label:"Categoría Principal (Se muestra al inicio de la página)"},{value:"SECONDARY", label:"Categoria Secundaria"}];

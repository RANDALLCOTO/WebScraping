...
const Modal = ({modalActionInfo, onCancel, onConfirm}) => {
  ...
  return (
<div id="popup-modal" tabIndex="-1" className="fixed bg-opacity-30 top-0 left-0 right-0 z-50 flex flex-col items-center justify-center bg-black p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
